...
namespace TestingRavenDB
{
    class Main1
    {
        public static void Main(string[] args)
        {
            ...
            {
                CountNumberOfPaymentsSmaller(session);
        ...
        public static void CountNumberOfPaymentsSmaller(IDocumentSession session)
        {
        ...
        public static void CreateSingleEntry(IDocumentSession session)
        {
            // Storing a language
        ...
        public static void LoadMultipleEntries(IDocumentSession session)
        {
        ...
        public static void LoadSingleEntry(IDocumentSession session)
        {
            // Get single Payment
        ...
        public static void LoadQuerying(IDocumentSession session)
        {
            // using Query
            List<Payment> results = session
                .Query<Payment>(collectionName: "Payment")
